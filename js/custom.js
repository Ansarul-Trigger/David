 ...
 */
 ...
 (window.onscroll = function () {
     ...
     $(".owl-carousel").owlCarousel({ loop: !0, nav: !1, items: 1, autoplay: !0, autoplayTimeout: 5000, autoplayHoverPause: !0, autoHeight: !1, autoHeightClass: "owl-height" }),
     $(window).on("load", function () {
         ...
         b.isotope({ filter: "*", layoutMode: "masonry", animationOptions: { duration: 750, easing: "linear" } }),
             c.find("a").on("click", function () {
                 ...
                 return c.find("a").removeClass("active"), $(this).addClass("active"), b.isotope({ filter: a, animationOptions: { animationDuration: 750, easing: "linear", queue: !1 } }), !1;
             });
     }),
